...
def main():
 ...
 allow=set(pages)|{'assets/global/navigation.css','assets/global/rollout.js','data/global03/publication-files.json','tools/global03/publication.py','README.md','tests/global_rollout/verify.py'}
