...
for r in raw:
 ...
 office_label=note.get('mandate','Mandato atual não confirmado')
 ...
 else: mandate_note=note.get('mandate_note','Exercício atual não confirmado. O histórico registra disputas e resultados, não toda a atuação pública.')
 tags=[]
 ...
 topics=note.get('topics','Pautas individuais ainda não consolidadas. Consulte os canais declarados; posições do partido não substituem um programa pessoal.')
