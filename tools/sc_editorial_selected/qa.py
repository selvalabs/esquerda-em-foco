    ...
    with sync_playwright() as p:
        ...
        try:
            for width in [320,360,390,430,768,1024,1440]:
                ...
                check(label+'Pautas e atuação mantêm títulos e ressalvas',page.locator('[data-section="historico"] h4').inner_text()=='Atuação registrada' and 'votação nominal' in page.locator('[data-section="historico"] .warning').inner_text())
                ...
                page.locator('#copyLink').click();check(label+'Cópia confirmada por adapter',len(page.evaluate('window.__copied'))==1 and 'Link copiado' in page.locator('#shareStatus').inner_text())
                page.locator('#nativeShare').click()
                ...
                page.evaluate('window.__clipReject=true');page.locator('#copyLink').click()
                ...
                page.evaluate('window.__clipReject=false;window.__shareResult="ok"');page.locator('#nativeShare').click()
                ...
                page.evaluate("location.hash='#selecionados=999999999999&v=1&edicao=sc-federais'");page.wait_for_timeout(50)
                ...
                page.locator('#clearCollection').click();page.locator('#cancelClear').click()
